...
export const bookingFlows: Flow[] = [
  ...
  { service: "Furniture assembly", matches: ["furniture", "assembly", "assemble", "bed", "desk", "dresser"], startingPrice: 119, time: "Tomorrow · 3:00 PM", detail: "Small or standard item · two-hour minimum", payment: "Final scope confirmed before payment", fields: [{ label: "Item type", options: ["Bed or bedroom piece", "Desk or workspace", "Storage or shelving"] }, { label: "Item size", options: ["Small / standard", "Large or complex", "Not sure"] }, { label: "Item count", options: ["One item", "Two or three", "Four or more"] }] },
  { service: "Picture hanging", matches: ["picture", "mirror", "frame", "artwork"], startingPrice: 99, time: "Tomorrow · 3:00 PM", detail: "Up to three small picture or frame hangings", payment: "Final scope confirmed before payment", fields: [{ label: "Items to hang", options: ["One small item", "Two or three small items", "Large or heavy item"] }, { label: "Wall type", options: ["Standard drywall", "Plaster, brick, tile, or not sure", "I need the right hardware"] }, { label: "Access", options: ["Reachable from the floor", "A ladder is needed", "High ceiling or stairwell"] }] },
  ...
  { service: "Handyman visit", matches: ["handyman", "repair", "hanging", "shelf", "patch", "drywall", "hardware", "fixing"], startingPrice: 129, time: "Saturday · 9:30 AM", detail: "Small repair · two-hour service minimum", payment: "Final scope confirmed before payment", fields: [{ label: "Job type", options: ["Small repair", "Hanging or mounting", "Patch, caulk, or touch-up"] }, { label: "Job count", options: ["One task", "A short list", "Several unrelated jobs"] }, { label: "Parts or hardware", options: ["I have them", "I need guidance", "Not sure"] }] },
