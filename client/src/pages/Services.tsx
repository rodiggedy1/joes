...
const catalog: Record<string, Service[]> = {
  Popular: [
    ...
    { title: "TV & wall mounting", description: "Televisions, soundbars, shelves, and cleaner cable setups for the room you use most.", request: "TV mounting", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663254023424/baSoauykNRogxOrL.jpg", accent: "TV & electronics", detailPath: "/services/tv-mounting" },
    { title: "Furniture assembly", description: "Beds, desks, dressers, shelving, and the just-delivered pieces that need a steady hand.", request: "furniture assembly", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663254023424/ApnFdzxltPesPxZG.jpg", accent: "Assembly", detailPath: "/services/furniture-assembly" },
    ...
    { title: "Interior painting", description: "A fresh wall, a focused accent, or the finishing touch that changes how a room feels.", request: "interior painting", image: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663254023424/TrUJosFNIoPbWYDk.jpg", accent: "Painting", detailPath: "/services/interior-painting" },
  ],
  Cleaning: [
