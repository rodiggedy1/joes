...
export default function Home() {
  ...
  return (
    <>
      <div className="site">
        <header>
          <div className="brand"><div className="logo"><img className="brand-mark" src="/manus-storage/good-house-co-mark_c955cb98.png" alt="" /></div><div><strong>Good House Co.</strong><small>The good kind of help for home</small></div></div>
        ...
        <footer><div className="brand"><div className="logo"><img className="brand-mark" src="/manus-storage/good-house-co-mark_c955cb98.png" alt="" /></div><strong>Good House Co.</strong></div><span>The good kind of help for home</span><span>Secure booking · Insured professionals</span></footer>
      </div>
